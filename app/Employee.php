...
class Employee extends Model
{
	...
	{
		return $this->hasOne('App\MasterReligion', 'id', 'religion_id');
	}
	...
	public function setFinishContractAttribute($value)
	{
		$this->attributes['finish_contract'] = Carbon::createFromFormat(env('Date_Format'), $value)->format('Y-m-d');
	}

	public function getFinishContractAttribute($value)
	{
		if($value === null)
		{
			return '';
	...
	public function setPermanentDateAttribute($value)
	{
		$this->attributes['permanent_date'] = Carbon::createFromFormat(env('Date_Format'), $value)->format('Y-m-d');
	}

	public function getPermanentDateAttribute($value)
	{
		if($value === null)
		{
			return '';
